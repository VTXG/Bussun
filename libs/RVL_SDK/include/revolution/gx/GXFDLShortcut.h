...
#define SC_TEV_REGISTERL_SET_R8(tev_registerl, r8) FAST_GPFLAGSET(tev_registerl, r8, TEV_REGISTERL_R8)
...
#define SC_TEV_REGISTERL_SET_A8(tev_registerl, a8) FAST_GPFLAGSET(tev_registerl, a8, TEV_REGISTERL_A8)
...
#define SC_TEV_REGISTERH_SET_B8(tev_registerh, b8) FAST_GPFLAGSET(tev_registerh, b8, TEV_REGISTERH_B8)
...
#define SC_TEV_REGISTERH_SET_G8(tev_registerh, g8) FAST_GPFLAGSET(tev_registerh, g8, TEV_REGISTERH_G8)
...
#define XF_AMBIENT0_F_RGBA_SIZE ((XF_AMBIENT0_F_ALPHA_SIZE) + (XF_AMBIENT0_F_BLUE_SIZE) + (XF_AMBIENT0_F_GREEN_SIZE) + (XF_AMBIENT0_F_RED_SIZE))
...
#define XF_AMBIENT0_F_RGB_MASK ((XF_AMBIENT0_F_BLUE_MASK) | (XF_AMBIENT0_F_GREEN_MASK) | (XF_AMBIENT0_F_RED_MASK))

#define SC_XF_AMBIENT0_F_SET_RGB(xf_ambient0_f, rgb) FAST_GPFLAGSET(xf_ambient0_f, rgb, XF_AMBIENT0_F_RGB)

#define XF_AMBIENT1_F_RGBA_SIZE ((XF_AMBIENT1_F_ALPHA_SIZE) + (XF_AMBIENT1_F_BLUE_SIZE) + (XF_AMBIENT1_F_GREEN_SIZE) + (XF_AMBIENT1_F_RED_SIZE))
...
#define XF_AMBIENT1_F_RGB_MASK ((XF_AMBIENT1_F_BLUE_MASK) | (XF_AMBIENT1_F_GREEN_MASK) | (XF_AMBIENT1_F_RED_MASK))
#define SC_XF_AMBIENT1_F_SET_RGB(xf_ambient1_f, rgb) FAST_GPFLAGSET(xf_ambient1_f, rgb, XF_AMBIENT1_F_RGB)
...
#define XF_MATERIAL0_F_RGB_SIZE ((XF_MATERIAL0_F_BLUE_SIZE) + (XF_MATERIAL0_F_GREEN_SIZE) + (XF_MATERIAL0_F_RED_SIZE))
#define XF_MATERIAL0_F_RGB_SHIFT XF_MATERIAL0_F_BLUE_SHIFT
#define XF_MATERIAL0_F_RGB_MASK ((XF_MATERIAL0_F_BLUE_MASK) | (XF_MATERIAL0_F_GREEN_MASK) | (XF_MATERIAL0_F_RED_MASK))
#define SC_XF_MATERIAL0_F_SET_RGB(xf_material0_f, rgb) FAST_GPFLAGSET(xf_material0_f, rgb, XF_MATERIAL0_F_RGB)
...
#define XF_MATERIAL1_F_RGBA_SIZE ((XF_MATERIAL1_F_ALPHA_SIZE) + (XF_MATERIAL1_F_BLUE_SIZE) + (XF_MATERIAL1_F_GREEN_SIZE) + (XF_MATERIAL1_F_RED_SIZE))
...
#define XF_MATERIAL1_F_RGB_MASK ((XF_MATERIAL1_F_BLUE_MASK) | (XF_MATERIAL1_F_GREEN_MASK) | (XF_MATERIAL1_F_RED_MASK))
#define SC_XF_MATERIAL1_F_SET_RGB(xf_material1_f, rgb) FAST_GPFLAGSET(xf_material1_f, rgb, XF_MATERIAL1_F_RGB)
...
#define XF_COLOR0CNTRL_F_LIGHT0123_SHIFT XF_COLOR0CNTRL_F_LIGHT0_SHIFT
#define XF_COLOR0CNTRL_F_LIGHT0123_MASK                                                                                                              \
    ((XF_COLOR0CNTRL_F_LIGHT0_MASK) | (XF_COLOR0CNTRL_F_LIGHT1_MASK) | (XF_COLOR0CNTRL_F_LIGHT2_MASK) | (XF_COLOR0CNTRL_F_LIGHT3_MASK))
#define SC_XF_COLOR0CNTRL_F_SET_LIGHT0123(xf_color0cntrl_f, light0123) FAST_GPFLAGSET(xf_color0cntrl_f, light0123, XF_COLOR0CNTRL_F_LIGHT0123)

#define XF_COLOR0CNTRL_F_LIGHT4567_SIZE                                                                                                              \
    ((XF_COLOR0CNTRL_F_LIGHT4_SIZE) + (XF_COLOR0CNTRL_F_LIGHT5_SIZE) + (XF_COLOR0CNTRL_F_LIGHT6_SIZE) + (XF_COLOR0CNTRL_F_LIGHT7_SIZE))
#define XF_COLOR0CNTRL_F_LIGHT4567_SHIFT XF_COLOR0CNTRL_F_LIGHT4_SHIFT
#define XF_COLOR0CNTRL_F_LIGHT4567_MASK                                                                                                              \
    ((XF_COLOR0CNTRL_F_LIGHT4_MASK) | (XF_COLOR0CNTRL_F_LIGHT5_MASK) | (XF_COLOR0CNTRL_F_LIGHT6_MASK) | (XF_COLOR0CNTRL_F_LIGHT7_MASK))
#define SC_XF_COLOR0CNTRL_F_SET_LIGHT4567(xf_color0cntrl_f, light4567) FAST_GPFLAGSET(xf_color0cntrl_f, light4567, XF_COLOR0CNTRL_F_LIGHT4567)

#define TEV_FOG_COLOR_RGB_SIZE ((8) + (8) + (8))
#define TEV_FOG_COLOR_RGB_SHIFT 0
#define TEV_FOG_COLOR_RGB_MASK ((TEV_FOG_COLOR_R_MASK) | (TEV_FOG_COLOR_G_MASK) | (TEV_FOG_COLOR_B_MASK))
#define SC_TEV_FOG_COLOR_SET_RGB(tev_fog_color, rgb) FAST_GPFLAGSET(tev_fog_color, rgb, TEV_FOG_COLOR_RGB)
