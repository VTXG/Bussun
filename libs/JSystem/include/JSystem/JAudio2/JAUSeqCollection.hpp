...
public:
    ...
    virtual ~JAUSeqDataMgr_SeqCollection();
    virtual SeqDataReturnValue getSeqData(JAISoundID, JAISeqData*);
    virtual int releaseSeqData();
    virtual bool setSeqDataUser(JAISeqDataUser*);
